...
{		
	QuadWidth = 2.0f / ((float)GridColumns + 1.0f);
	QuadHeight = 2.0f / ((float)GridRows + 1.0f);
...
{
	float xPos = (2.0f * (float)sharkPosition.X / (float)GridColumns) - 1.0f;
	float yPos = (2.0f * (float)sharkPosition.Y / (float)GridRows) - 1.0f;
...
{
	float xPos = (2.0f * (float)fishPosition.X / (float)GridColumns) - 1.0f;
	float yPos = (2.0f * (float)fishPosition.Y / (float)GridRows) - 1.0f;
